...
- **Task（任务）**: 清晰定义任务： - 具体的任务描述 - 任务的范围和边界 - 预期的输出类型 - 关键的约束条件
- **Role（角色）**: 指定AI的角色： - 专业身份 - 专业水平 - 个性特征 - 知识范围
- **Audience（受众）**: 明确目标受众： - 受众特征 - 知识水平 - 需求和期望 - 阅读/使用场景
- **Create（创建）**: 指导创建过程： - 格式要求 - 风格指南 - 必需包含的元素 - 禁止的内容
- **Evaluate（评估）**: 设定成功标准： - 质量衡量标准 - 完整性检查 - 准确性验证 - 可用性评估
...
使用TRACE框架时，建议使用以下XML标签结构化您的提示词：
