...
- **引言**: 开篇部分的作用： - 引入主题，提供背景 - 吸引读者的注意力 - 明确文章的目的或论点 - 预告主要内容
- **主体**: 内容的核心部分： - 通常包含2-4个主要论点 - 每个论点都有支持证据 - 逻辑清晰，层次分明 - 各段落之间有过渡
- **结论**: 收尾部分的作用： - 总结主要观点 - 重申核心论点 - 提供行动号召或展望 - 给读者留下深刻印象
...
使用Hamburger Model框架时，建议使用以下XML标签结构化您的提示词：
