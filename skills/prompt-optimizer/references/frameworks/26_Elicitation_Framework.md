...
- **开放式问题**: 使用"什么"、"如何"、"为什么"等开放式问题，鼓励受访者提供详细的回答而非简单的是/否。
- **探索性追问**: 对初始回答进行深入追问，了解背后的原因、动机和约束条件。
- **假设验证**: 提出假设性场景或解决方案，让受访者评论和纠正，以验证理解的准确性。
- **情景模拟**: 使用具体的使用场景或故事，帮助受访者更好地表达他们的需求和期望。
- **确认总结**: 定期总结已收集的信息，并向受访者确认理解的准确性。
...
使用Elicitation框架时，建议使用以下XML标签结构化您的提示词：
